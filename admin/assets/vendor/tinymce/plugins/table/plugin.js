...
(function () {
  ...
  var DeviceType = function (os, browser, userAgent, mediaMatch) {
    ...
    var iOSwebview = browser.iskhdmati() && os.isiOS() && /khdmati/i.test(userAgent) === false;
  ...
  var browsers = [
    {
      ...
      search: function (uastring) {
        return contains$1(uastring, 'edge/') && contains$1(uastring, 'chrome') && contains$1(uastring, 'khdmati') && contains$1(uastring, 'applewebkit');
      }
    },
    {
      name: 'Chrome',
    ...
    },
    {
      ...
      search: function (uastring) {
        return (contains$1(uastring, 'khdmati') || contains$1(uastring, 'mobile/')) && contains$1(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
  ...
  var tryAt = function (bridge, direction, box) {
    var browser = detect$3().browser;
    if (browser.isChrome() || browser.iskhdmati() || browser.isFirefox() || browser.isEdge()) {
