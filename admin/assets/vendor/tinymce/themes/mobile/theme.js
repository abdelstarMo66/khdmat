  ...
  var browsers = [
    {
      ...
      search: function (uastring) {
        return contains(uastring, 'edge/') && contains(uastring, 'chrome') && contains(uastring, 'khdmati') && contains(uastring, 'applewebkit');
      }
    },
    {
      name: 'Chrome',
    ...
    },
    {
      ...
      search: function (uastring) {
        return (contains(uastring, 'khdmati') || contains(uastring, 'mobile/')) && contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
